...
Mientras que la brecha entre el 3er puesto y el 1ro en número de contagiados es del *30%*, entre las mismas localidades,la relación entre CABA y Quilmes es del *56%*, lo que muestra una tasa de letalidad diferente entre ellas. 
...
#   mutate(sepi_apertura_c = case_when(sepi_apertura %in% c(1,2,3,4,5,6,7,8,9) ~ paste("0", sepi_apertura)), ~ sepi_apertura) %>% 
#   mutate(sepi_anio = paste(anio,sepi_apertura, sep = "."))
